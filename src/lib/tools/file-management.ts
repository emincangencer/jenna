...
export const listFilesTool = tool({
  description:
    'List files and directories in a given path. Defaults to the project root if no path is provided.',
  inputSchema: z.object({
    pathToList: z
      .string()
      .optional()
      .describe('The path to list files from. Defaults to the project root.'),
  }),
...
export const writeFileTool = tool({
  description:
    'Write content to a specified file. If the file does not exist, it will be created. If it exists, its content will be overwritten.',
  inputSchema: z.object({
